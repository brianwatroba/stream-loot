...
const App = () => {
  return (
    <>
      ...
      <div className="text-3xl font-serif font-bold text-black33 text-center lg:text-4xl mt-48 mb-8 lg:mb-24">
        How it works
      </div>
      ...
      <div className="flex flex-col justify-center py-36 bg-gradient-to-t from-[#FFFAED] to-white">
        <FeatureItem title="View your loot" imgSrc={chest} alt="chest" />
        <div className="flex justify-center text-sm mb-8 text-sm lg:text-lg text-black80 font-normal font-sans text-center italic mb-16">
